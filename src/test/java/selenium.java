...
public class selenium {
    public static void main(String[] args) throws InterruptedException {
       ...
       driver.findElement(By.xpath("//*[@id=\"header\"]/div[2]/div/div/nav/div[1]/a")).click();
        driver.findElement(By.id("email_create")).sendKeys("test783@gmail.com");
        driver.findElement(By.xpath("//*[@id=\"SubmitCreate\"]/span")).click();
        Thread.sleep(5000); //5sec sleep
        ...
        driver.findElement(By.id("days")).sendKeys("3");//Date of Birth (days)
        driver.findElement(By.id("months")).sendKeys("may");//Date of Birth (months)
        driver.findElement(By.id("years")).sendKeys("1987");//Date of Birth (years)
        ...
        driver.findElement(By.id("id_state")).sendKeys("aa");//the State *
